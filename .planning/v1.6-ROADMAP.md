...
- [ ] **Phase 23: Database & Backend Services** - Schema extensions and service layer for sync items/subtasks
...
Plans:
- [ ] 23-01-PLAN.md - Database schema migration (tables, columns, indexes, triggers)
- [ ] 23-02-PLAN.md - Backend services (SyncItemService, SubtaskService, SyncSettingsService)
...
Plans:
- [ ] 24-01: Sync item routes (CRUD, archive, restore)
- [ ] 24-02: Subtask and settings routes
...
|-------|----------------|--------|-----------|
| 23. Database & Backend Services | 0/2 | Planned | - |
| 24. REST API | 0/2 | Not started | - |
...
*Last updated: 2026-01-29 after Phase 23 planning*
