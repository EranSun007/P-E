...
Plans:
- [ ] 23-01: Database schema migration (tables, columns, indexes, triggers)
- [ ] 23-02: Backend services (SyncItemService, SubtaskService, SyncSettingsService)
...
|-------|----------------|--------|-----------|
| 23. Database & Backend Services | 0/2 | Not started | - |
