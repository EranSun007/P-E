...
// Comprehensive end-to-end integration tests for complete calendar workflow
...
describe('Calendar Workflow Integration - End-to-End Tests', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe('Complete OneOnOne to Calendar Event Workflow', () => {
  ...
  describe('Weekly Meeting Sidebar Functionality', () => {
  ...
  describe('Enhanced Event Styling Consistency', () => {
  ...
  describe('Recurring Birthday Event Generation and Display', () => {
