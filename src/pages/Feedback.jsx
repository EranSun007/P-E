    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          )}>Collect and analyze customer feedback</p>
        </div>
      ...
      <Card className={cn(
        ...
        <CardContent className="flex flex-col items-center justify-center py-16">
          ...
          )}>No feedback collected</CardTitle>
          <p className={cn(
            "text-center max-w-md",
            isProductMode ? "text-gray-500" : "text-gray-400"
          )}>
            Start collecting customer feedback. Track feature requests, NPS scores,
            and user sentiment to improve your product.
          </p>
