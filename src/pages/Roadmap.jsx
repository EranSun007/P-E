    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          )}>Plan and visualize your product roadmap</p>
        </div>
      ...
      <Card className={cn(
        ...
        <CardContent className="flex flex-col items-center justify-center py-16">
          ...
          )}>No roadmap items yet</CardTitle>
          <p className={cn(
            "text-center max-w-md",
            isProductMode ? "text-gray-500" : "text-gray-400"
          )}>
            Build your product roadmap here. Add milestones, features, and releases to
            track your product's journey over time.
          </p>
