 ...
 * Displays total out of office days for a team member for the current calendar year
...
const OutOfOfficeCounter = ({
  ...
  const loadStats = async (year) => {
    ...
    try {
      ...
      const yearlyStats = await OutOfOfficeService.getYearlyStats(teamMemberId, year);
      ...
      console.error('Failed to load out of office stats:', err);
...
export default OutOfOfficeCounter;